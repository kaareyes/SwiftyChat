    ...
    var body: some View {
        chatView
            .onAppear {
                ...
                self.messages.append(.init(user: MockMessages.chatbot, messageKind: .text(true,false,"<p>Amigo Reyes</p> Contrary to popular belief, Lorem Ipsum is not just random text. It originated from a piece of classical Latin literature written in 45 BC by Cicero. A Latin professor named Richard McClintock traced the word “consectetur” back to Cicero’s philosophical work “De Finibus Bonorum et Malorum” (The Extremes of Good and Evil).", ["Jett Calleja","Juan Carlos","amigo Reyes"], .attention, nil,[MessageReaction(reactionId: "1", emoji: "🥺", userId: "2"),MessageReaction(reactionId: "2", emoji: "😍", userId:"1")],false), messageUUID: UUID().uuidString))
                self.messages.append(.init(user: MockMessages.chatbot, messageKind: .text(false,false,"<p>Amigo Reyes</p> https://medchat.s3.amazonaws.com/90709491-e2f0-444a-a2f0-f24543d60951dummy.pdf testing , facebook.com <p>Amigo Reyes</p> https://medchat.s3.amazonaws.com/90709491-e2f0-444a-a2f0-f24543d60951dummy.pdf testing , facebook.com <p>Amigo Reyes</p> https://medchat.s3.amazonaws.com/90709491-e2f0-444a-a2f0-f24543d60951dummy.pdf testing , facebook.com <p>Amigo Reyes</p> https://medchat.s3.amazonaws.com/90709491-e2f0-444a-a2f0-f24543d60951dummy.pdf testing , facebook.com <p>Amigo Reyes</p> https://medchat.s3.amazonaws.com/90709491-e2f0-444a-a2f0-f24543d60951dummy.pdf testing , facebook.com <p>Amigo Reyes</p> https://medchat.s3.amazonaws.com/90709491-e2f0-444a-a2f0-f24543d60951dummy.pdf testing , facebook.com", ["Jett Calleja","Juan Carlos","amigo Reyes"], .attention, nil,nil,false), messageUUID: UUID().uuidString,seenRecipients: [SeenAvatarUser(id: "1", name: "", imageUrl: URL(string: "https://fastly.picsum.photos/id/659/200/200.jpg?hmac=kFpdD3XTBGwPUAH1tD-AiWigstjIX8WGIcyySuVQIvE")),SeenAvatarUser(id: "1", name: "", imageUrl: URL(string: "https://fastly.picsum.photos/id/659/200/200.jpg?hmac=kFpdD3XTBGwPUAH1tD-AiWigstjIX8WGIcyySuVQIvE")),SeenAvatarUser(id: "1", name: "", imageUrl: URL(string: "https://fastly.picsum.photos/id/659/200/200.jpg?hmac=kFpdD3XTBGwPUAH1tD-AiWigstjIX8WGIcyySuVQIvE")),SeenAvatarUser(id: "1", name: "", imageUrl: URL(string: "https://fastly.picsum.photos/id/659/200/200.jpg?hmac=kFpdD3XTBGwPUAH1tD-AiWigstjIX8WGIcyySuVQIvE")),SeenAvatarUser(id: "1", name: "", imageUrl: URL(string: "https://fastly.picsum.photos/id/659/200/200.jpg?hmac=kFpdD3XTBGwPUAH1tD-AiWigstjIX8WGIcyySuVQIvE")),SeenAvatarUser(id: "1", name: "", imageUrl: URL(string: "https://fastly.picsum.photos/id/659/200/200.jpg?hmac=kFpdD3XTBGwPUAH1tD-AiWigstjIX8WGIcyySuVQIvE")),SeenAvatarUser(id: "1", name: "", imageUrl: URL(string: "https://fastly.picsum.photos/id/659/200/200.jpg?hmac=kFpdD3XTBGwPUAH1tD-AiWigstjIX8WGIcyySuVQIvE"))]))
                
                
                self.messages.append(.init(user: MockMessages.chatbot, messageKind: .isTyping, messageUUID: UUID().uuidString))
