...
struct BasicExampleView: View {
    ...
    var body: some View {
        chatView
            .onAppear {
                self.messages.append(.init(user: MockMessages.chatbot, messageKind: .text("<p>Amigo Reyes</p>", ["Jett Calleja","Juan Carlos","amigo Reyes"], .attention, nil,[MessageReaction(reactionId: "1", emoji: "🥺", count: 12),MessageReaction(reactionId: "2", emoji: "😍", count: 12)]), messageUUID: UUID().uuidString))
